<?php namespace App\Http\Controllers;
	...
	class AdminConfirmasiController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Info Sampah','name'=>'id_info_sampah','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'info_sampah,id'];
			...
			$this->form[] = ['label'=>'Aksi','name'=>'id_aksi','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'aksi,id'];
			...
			//$this->form[] = ["label"=>"Info Sampah","name"=>"id_info_sampah","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"info_sampah,id"];
			...
			//$this->form[] = ["label"=>"Aksi","name"=>"id_aksi","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"aksi,id"];
			# OLD END FORM
