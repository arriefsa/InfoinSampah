<?php namespace App\Http\Controllers;
	...
	class AdminInformasiController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Infomasi","name"=>"infomasi"];
			$this->col[] = ["label"=>"Tanggal","name"=>"tanggal"];
			$this->col[] = ["label"=>"Subject","name"=>"subject"];
			$this->col[] = ["label"=>"Keterangan","name"=>"keterangan"];
			$this->col[] = ["label"=>"Katagori","name"=>"id_katagori","join"=>"katagori,id"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Infomasi','name'=>'infomasi','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Katagori','name'=>'id_katagori','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'katagori,id'];
			# END FORM DO NOT REMOVE THIS LINE

			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Infomasi","name"=>"infomasi","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"Katagori","name"=>"id_katagori","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"katagori,id"];
			# OLD END FORM
